	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'workNo',title:'工号',width:150},
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "即将删除该工人，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
	...
	<div id="addDialog" style="padding: 10px;">  
   		<form id="addForm" method="post">
	    	<table id="addTable" border=0 cellpadding="8" >
				...
				<tr>
					<td>年龄:</td>
					<td ><input id="add_age" style="width: 200px; height: 30px;" class="easyui-textbox" type="number" name="age" data-options="required:true, missingMessage:'请填写年龄'" /></td>
				</tr>
				<tr>
					<td>性别:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" cellpadding="8" >
				...
				<tr>
					<td>年龄:</td>
					<td ><input id="edit_age" style="width: 200px; height: 30px;" class="easyui-textbox" type="number" name="age" data-options="required:true, missingMessage:'请填写年龄'" /></td>
				</tr>
				<tr>
					<td>性别:</td>
