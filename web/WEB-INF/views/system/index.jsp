...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <c:if test="${userType=='2'}">
            <span style="float:right; padding-right:20px;" class="head"><span style="color:red; font-weight:bold;">${user.stuName}&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="LoginOut" id="loginOut2">安全退出</a></span>
        </c:if>
        <c:if test="${userType=='3'}">
            <span style="float:right; padding-right:20px;" class="head"><span style="color:red; font-weight:bold;">${user.name}&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="LoginOut" id="loginOut3">安全退出</a></span>
        </c:if>
        <c:if test="${userType=='4'}">
            <span style="float:right; padding-right:20px;" class="head"><span style="color:red; font-weight:bold;">${user.name}&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="LoginOut" id="loginOut4">安全退出</a></span>
        </c:if>
